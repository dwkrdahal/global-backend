...
const { uploadArrayImages, uploadSingleImage } = uploader;

//  /project/
router
  .route("/")
  .post(isLoggedIn, uploadArrayImages(10), prjCtrl.insertProject)
...
router
  ...
  .patch(isLoggedIn, uploadArrayImages(10), prjCtrl.updateProject)
